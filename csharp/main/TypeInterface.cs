...
{
	public sealed class TypeInterface : TypeCustom, IEquatable<TypeInterface>
	{
		...
		public InterfaceDef Definition { get; }
		...
		public override Boolean Equals(Object obj) => Equals(obj as TypeInterface);

		/// <summary>Indicates whether the current object is equal to another object of the same type.</summary>
		/// <returns>true if the current object is equal to the <paramref name="other" /> parameter; otherwise, false.</returns>
		/// <param name="other">An object to compare with this object.</param>
		public Boolean Equals(TypeInterface other) => other != null && Definition.Equals(other.Definition);
